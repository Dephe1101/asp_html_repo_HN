...
<x-app-layout>
    ...
    <section id="wrapper-content">
        <div class="wrapper-title">
            <div class="container">
                <h2 class="head-title text-center">Đăng ký tài khoản</h2>
            </div>
        </div>
        <div class="container">
            <div class="box-credit-form py-5 d-flex flex-column">
                <form id="register" method="POST" action="{{ route('register.store') }}">
                    @csrf
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-around flex-ct-column w-100">
                            ...
                            <div class="w-65">
                                <div class="input-group">
                                    <input id="InputPass" style="border-right: 0;" type="password" name="password" class="form-control @error('password') is-invalid @enderror" required>
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-around flex-ct-column w-100">
                            <div class="w-35 pt-2"><b class="fs-6">{{ __('Xác nhận mật khẩu') }}</b> <span
                                    class="text-danger fw-bold">*</span></div>
                            <div class="w-65">
                                <div class="input-group">
                                    <input id="InputPass1" type="password" name="password_confirmation" class="form-control" required style="border-right: 0;">
                ...
                <a href="#" class="btn btn-primary mt-4" onclick="submitForm()">{{ __('Đăng ký tài khoản') }}</a>
                <p class="txt-register text-center mt-3">Nếu bạn đã có tài khoản ? <a href="{{ route('login.show') }}">Đăng nhập ngay</a></p>
            </div>
        </div>
    </section>
</x-app-layout>
