...
<x-app-layout>
    <x-slot name="head">
        <script>
            function submitForm() {
                const form = document.getElementById("form_bank_info");
                form.submit();
            }
        </script>
    </x-slot>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Thông tin ngân hàng</li>
                </ol>
            </nav>
        </div>
    </section>
    <section id="wrapper-content">
        <div class="container">
            <div class="box-credit-form py-5 d-flex flex-column">
                <form id="form_bank_info" method="POST" action="{{ route('bank_info.store') }}">
                    @csrf
                    @if (session('error'))
                    ...
                    <div class="box-upload-img">
                        <div class="mb-3 w-100 item-upload-img border-0 p-0 position-relative">
                            ...
                            <div class="box-info d-flex justify-content-between w-100 px-3">
                                <span class="stk-card">1234</span>
                                <span class="stk-card">5678</span>
                                <span class="stk-card">****</span>
                                <span class="stk-card">****</span>
                            </div>
                            <span class="chu-tai-khoan">TÊN TÀI KHOẢN</span>
                            <span class="ngay-mo-the">XX/XX</span>
                        </div>
                        <div class="mb-3">
                            <div class="d-flex justify-content-around flex-ct-column w-100">
                                ...
                                <div class="w-65">
                                    <input name="bank_number" value="{{ old('bank_number') }}" type="text" class="form-control @error('bank_number') is-invalid @enderror" required autofocus>
                                    @error('bank_number')
                        ...
                        <div class="mb-3">
                            <div class="d-flex justify-content-around flex-ct-column w-100">
                                <div class="w-35 pt-2"><b class="fs-6">Tên chủ tài khoản</b> <span
                                        class="text-danger fw-bold">*</span></div>
                                <div class="w-65">
                                    <input name="bank_account" value="{{ old('bank_account') }}" type="text" class="form-control @error('bank_account') is-invalid @enderror" required autofocus>
                                    @error('bank_account')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="d-flex justify-content-around flex-ct-column w-100">
                                ...
                                <div class="w-65">
                                    <select name="bank_type" class="form-select @error('bank_type') is-invalid @enderror" required autofocus>
                                        ...
                                        <option value="1">Thẻ visa</option>
                        ...
                        <div class="mb-3">
                            <div class="w-100">
                                <p class="text-center" style="color:#da2028">Lưu ý: vui lòng nhập thông tin chính xác để được xét duyệt nhanh hơn</p>
                            </div>
                        </div>
                    </div>
                </form>
